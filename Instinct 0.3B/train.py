...
CKPT_DIR = os.path.abspath("./ckpt2")
VAL_SPLIT = 0.01          # 1% of data for validation
VAL_TOKENS = 5_000_000    # tokens per validation run
VAL_INTERVAL = 500_000_000  # validate every 5B tokens
LOG_FILE = "training_log_150.txt"
PPL_FILE = "val_perplexity_150.txt"
...
TOTAL_TOKENS_TARGET = 30_000_000_000
WARMUP_FRAC = 0.01

SANITY_TOKENS = 10_000_000
CKPT_INTERVAL = 6_000_000_000
